  ...
  <div id="home-content">
    <div class="essay">
      ...
      <div class="essay-content" v-for="(item, index) in essay" :key="index">
        ...
        <div class="essay-title" @click="toEssay('/essay',item.essayid),reload()">{{ item.title }}</div>
        <div class="essay-sentence">{{ item.sentence | ellipsisSentence }}</div>

        <div class="essay-footer">
          <span class="essay-author-name" @click="toAuthor('/author',item.author.authorid),reload()">{{ item.author.authorname }}</span>
