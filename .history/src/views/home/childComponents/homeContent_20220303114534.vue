    ...
    <div class="essay">
      <div class="essay-rank">
        ...
        >
          ...
          <span class="essay-rank-tips">{{item.tips}}</span>
        </div>
      </div>
...
.essay-rank-tips:nth-child(1):hover{
  display: block;
  left: -10px;
}
.essay-rank-tips:nth-child(2):hover{
  display: block;
  left: 40px;
}
.essay-rank-tips:nth-child(3):hover{
  display: block;
  left: 60px;
}


.essay-rank-box:nth-child(1):hover {
  cursor: pointer;
}
.essay-rank-box:nth-child(3):hover {
  cursor: pointer;
}
.essay-rank-box:nth-child(5):hover {
  cursor: pointer;
}
