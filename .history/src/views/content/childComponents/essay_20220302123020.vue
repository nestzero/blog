  ...
  <div id="essay">
    ...
    <div class="essay_content_recommend">
      <div class="essay_content_author">
        <div class="essay_content_authorname"><span></span>{{essay.author.authorname}}</div>
        <span class="essay_content_subscribe">{{essay.author.subscribe}}</span>
        <span class="essay_content_subscribed">{{essay.author.subscribed}}</span>
      </div>
    </div>
  </div>
</template>
