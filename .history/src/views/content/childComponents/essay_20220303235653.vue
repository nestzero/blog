      ...
      <div class="essay_content_author">
        ...
        <div class="essay_content_star">
          <div class="essay_content_box">
            ...
            <span>收藏</span>
            <span>{{ essayObject.kpi.stars | countNums }}</span>
          </div>
        </div>
      </div>
