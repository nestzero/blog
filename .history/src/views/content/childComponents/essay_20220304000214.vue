  ...
  <div id="essay">
    <!-- <div class="essay_content">
      <div class="essay_content_title">
        <span class="essay_content_title_top">{{ essay[0].title }}</span>

        <div class="essay_content_title_footer">
          <span class="essay_content_title_item">{{essay[0].author.authorname}}</span>
          <span class="essay_content_title_item">{{ essay[0].datetime | formatTime }} ·</span>
          <span class="essay_content_title_item">{{ essay[0].kpi.watch | countNums }} 阅读</span>
        </div>
      </div>

      <div class="essay_content_mainbody">{{ essay[0].sentence }}</div>
    </div> -->

    <div class="essay_content_recommend">
      <!-- <div class="essay_content_author">
        <div class="essay_content_authorname">
          <span @click="toAuthor('/author', essay[0].author.authorid)">{{essay[0].author.authorname}}</span>
        </div>

        <div class="essay_content_subscribe">
          <div class="essay_content_subscribe_left">
            <span>{{ essay[0].author.subscribe | countNums }}</span>
            <div>关注</div>
          </div>
          <span class="essay_content_subscribe_line">|</span>
          <div class="essay_content_subscribe_right">
            <span>{{ essay[0].author.subscribed | countNums }}</span>
            <div>被关注</div>
          </div>
        </div>
        ...
        <div class="essay_content_star">
          <div class="essay_content_box">
            ...
            <span>收藏</span>
            <span>{{ essay[0].kpi.stars | countNums }}</span>
          </div>
        </div>
      </div>
